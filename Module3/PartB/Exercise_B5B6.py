'''
System Biology Module 3 Part B: Exercise B.5, B.6
Author: Weizhou Xing
...
def run_model():
    ...
    print 'Exercise B.5'
    max_fluxes(sbml, ['EX_fru(e)'], [50], [True])

    cs = ['EX_glc(e)']
    v = [50]
    n = [False, True]
    max_fluxes(sbml, cs, v, n)
    print 'Exercise B.6'
    cs = [['EX_glc(e)', 'EX_fru(e)']]
    v = [[25,25]]
    n = [False, True]
    max_fluxes(sbml, cs, v, n)
...
def max_fluxes(sbml, carbon_sourcesl, valuesl, normoxicl):
    '''
    sbml: sbml object
    carbon_sources: ['EX_fru(e)', 'EX_glc(e)']
    normoxic: list of bool. e.g. [True, False]
    '''
    eps=1e-10
    objective = 'DM_atp_c_'
    # carbon_sourcesl = ['EX_fru(e)'];valuesl = [50];normoxicl=[True]
    # carbon_sourcesl = ['EX_glc(e)'];valuesl = [50];normoxicl=[False, True]
    # carbon_sourcesl = [['EX_fru(e)', 'EX_glc(e)']]; valuesl=[25,25];normoxicl=[True, False]
...
def max_flux(sbml, carbon_sourcel, valuel, objective, normoxic, media):
    ...
    set_import_bounds(sbml, carbon_sourcel, valuel)
    # define media
